...
def run():
    ...
    files_data = [
        ["NotoSans-Regular.ttf",
         "https://github.com/Zapzatron/GUI/raw/master/Fonts/NotoSans-Regular.ttf",
         "Fonts"],
        ["russian_nouns.txt",
         "https://github.com/Zapzatron/GUI/raw/master/Generator_dictionaries/russian_nouns.txt",
         "Generator_dictionaries"],
        ["russian_nouns_without_io.txt",
         "https://github.com/Zapzatron/GUI/raw/master/Generator_dictionaries/russian_nouns_without_io.txt",
         "Generator_dictionaries"],
        ["degget_6564_App.jpg",
         "https://github.com/Zapzatron/GUI/raw/master/Photos_or_Icons/degget_6564_App.jpg",
         "Photos_or_Icons"],
        ["readme.md",
         "https://github.com/Zapzatron/GUI/raw/master/readme.md",
         None]
    ]
